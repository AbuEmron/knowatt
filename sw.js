/* Wattson service worker — BUMP THIS STRING ON EVERY RELEASE */
const CACHE="wattson-v1-2026-06-26";
const CORE=["/","/app/","/index.html","/app/index.html","/manifest.webmanifest",
  "/assets/wattson-icon-rounded.png","/assets/wattson-mark.svg","/assets/wattson-word.svg"];
